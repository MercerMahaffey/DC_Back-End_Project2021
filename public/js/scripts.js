$(document).ready(function() {
    ...
    //     let post = allPostsData[0].posts[0];
    //     let comments = post.comments;
    //     comments.forEach(comment => {
    //         commentsHtmlBlock += `<div class="card-body border-top-xs pt-4 pb-3 pe-4 d-block ps-5"> <figure class="avatar position-absolute left-0 ms-2 mt-1"></figure><div class="chat p-3 bg-greylight rounded-xxl d-block text-left theme-dark-bg"><h4 class="fw-700 text-grey-900 font-xssss mt-0 mb-1"> user name <a href="#" class="ms-auto"><i class="ti-more-alt float-right text-grey-800 font-xsss"></i></a></h4><p class="fw-500 text-grey-500 lh-20 font-xssss w-100 mt-2 mb-0">${comment.content}</p></div></div>`
    //     } )
    //     $('#lightbox').append(`<div class="right-comment chat-left scroll-bar theme-dark-bg">` + commentsHtmlBlock + `</div>`);
    // }
    
    // grabPost()
    // let commentsHtmlBlock = `<div class="right-comment chat-left scroll-bar theme-dark-bg"><div class="card-body border-top-xs pt-4 pb-3 pe-4 d-block ps-5"> <figure class="avatar position-absolute left-0 ms-2 mt-1"><img src="images/user-6.png" alt="image" class="shadow-sm rounded-circle w35"></figure><div class="chat p-3 bg-greylight rounded-xxl d-block text-left theme-dark-bg"><h4 class="fw-700 text-grey-900 font-xssss mt-0 mb-1"> user name <a href="#" class="ms-auto"><i class="ti-more-alt float-right text-grey-800 font-xsss"></i></a></h4><p class="fw-500 text-grey-500 lh-20 font-xssss w-100 mt-2 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor.</p></div></div></div>`
